...
<div class="box white">
    ...
    <p style="font-family:Alatsi;font-size: 16px; ">Pollo con papas a la francesa </p>
   <!--Precio -->
    <p align="right" style="margin: 1px  ; opacity: 0.6;">$85.00 </p><!--Precio -->
    <!--Clientes -->
    ...
    <div id="flotante" style="display:none;">
     <div  class="box2 white" id="close"><a href="javascript:cerrar();"><i class="fas fa-sort-up"></i></a>
      <p style="">Rico pollo azado con papas a la francesa y verduras. </p>
</div>
  </div>
  </div>
  </div>
    ...
    <!--Entidad para texto AR sin tarjet-->
     ...
     <a-marker preset='custom' type='pattern' url='assets/pattern-frame.patt'> <!--Tarjet para ubicar el platillo -->
              <!--Imagen a mostrar en AR(modelo) -->
                <a-image   width="4.3" height="2.6" src="pollo.png" look-controls  ></a-image>
                <!--Fin Modelo(modelo) -->
