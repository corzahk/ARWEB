...
<div class="box white">
    ...
    <p style="font-family:Alatsi;font-size: 16px; ">Sopa Crema de Zanahoria </p>
   <!--Precio -->
    <p align="right" style="margin: 1px  ; opacity: 0.6;">$54.00 </p><!--Precio -->
    <!--Clientes -->
    ...
    <div id="flotante" style="display:none;">
     <div  class="box2 white" id="close"><a href="javascript:cerrar();"><i class="fas fa-sort-up"></i></a>
      <p style="">Rica crema de zanahoria con especies. </p>
</div>
  </div>
  </div>
  </div>
    ...
    <!--Entidad para texto AR sin tarjet-->
     ...
     <a-marker preset='custom' type='pattern' url='assets/pattern-frame.patt'> <!--Tarjet para ubicar el platillo -->
              <!--Imagen a mostrar en AR(modelo) -->
                <a-image   width="4.3" height="2.6" src="seis.png" look-controls  ></a-image>
                <!--Fin Modelo(modelo) -->
