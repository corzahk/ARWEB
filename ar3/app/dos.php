...
<div class="box white">
    ...
    <p style="font-family:Alatsi;font-size: 16px; ">Corte de fino de res con ensalada. </p>
   <!--Precio -->
    ...
    <div  class="box2 white" id="close"><a href="javascript:cerrar();"><i class="fas fa-sort-up"></i></a>
      <p style="">Fino corte de Res, cocinado a su punto con una rica ensalada de verduras. </p>
</div>
  </div>
  </div>
  </div>
    ...
    <!--Entidad para texto AR sin tarjet-->
     ...
     <a-marker preset='custom' type='pattern' url='assets/pattern-frame.patt'> <!--Tarjet para ubicar el platillo -->
              <!--Imagen a mostrar en AR(modelo) -->
                <a-image   width="4.3" height="2.6" src="dos.png" look-controls  ></a-image>
                <!--Fin Modelo(modelo) -->
