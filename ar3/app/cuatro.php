...
<div class="box white">
    ...
    <p style="font-family:Alatsi;font-size: 16px; ">Papas a la francesa </p>
   <!--Precio -->
    <p align="right" style="margin: 1px  ; opacity: 0.6;">$35.00 </p><!--Precio -->
    <!--Clientes -->
    ...
    <div id="flotante" style="display:none;">
      ...
      <p style="">Rica orden de papas a la francesa con catsup. </p>
</div>
  </div>
  </div>
  </div>
    ...
    <!--Entidad para texto AR sin tarjet-->
     ...
     <a-marker preset='custom' type='pattern' url='assets/pattern-frame.patt'> <!--Tarjet para ubicar el platillo -->
              <!--Imagen a mostrar en AR(modelo) -->
                <a-image   width="4.3" height="2.6" src="cuatro.png" look-controls  ></a-image>
                <!--Fin Modelo(modelo) -->
