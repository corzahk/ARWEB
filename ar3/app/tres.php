...
<div class="box white">
    ...
    <p style="font-family:Alatsi;font-size: 16px; ">Filete corte sirloin de res y papas </p>
   <!--Precio -->
    ...
    <div id="flotante" style="display:none;">
     <div  class="box2 white" id="close"><a href="javascript:cerrar();"><i class="fas fa-sort-up"></i></a>
      <p style="">Rico Filete azado de Res acompalado con verduras frescas y papas a la francesa. </p>
</div>
  </div>
  </div>
  </div>
    ...
    <!--Entidad para texto AR sin tarjet-->
     ...
     <a-marker preset='custom' type='pattern' url='assets/pattern-frame.patt'> <!--Tarjet para ubicar el platillo -->
              <!--Imagen a mostrar en AR(modelo) -->
                <a-image   width="4.3" height="2.6" src="tres.png" look-controls  ></a-image>
                <!--Fin Modelo(modelo) -->
